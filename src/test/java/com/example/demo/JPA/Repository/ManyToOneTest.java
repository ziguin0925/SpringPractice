...
class ManyToOneTest {
    ...
    public void test() {
        ...
        b1.setUser(user);
        b1.setViewCnt(0L);
        b1.setInDate(new Date(System.currentTimeMillis()));
        b1.setUpDate(new Date(System.currentTimeMillis()));
        ...
        b2.setUser(user);
        b2.setViewCnt(0L);
        b2.setInDate(new Date(System.currentTimeMillis()));
        b2.setUpDate(new Date(System.currentTimeMillis()));
